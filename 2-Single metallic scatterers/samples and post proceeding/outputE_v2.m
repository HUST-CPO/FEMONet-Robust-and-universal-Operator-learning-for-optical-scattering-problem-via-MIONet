...
load(fullfile(mat_dir, 'Train_data_B1_50688.mat'))
load(fullfile(mat_dir, 'deepOnet_data_B1_50688.mat'))
load(fullfile(mat_dir, 'idx_B1_50688.mat'))
load(fullfile(mat_dir, 'E_test_pred_size_50688_bestmodel.mat'))
...
saveFieldPDFNoColorbar_SVGColorbar( ...
    fullfile(outdir, ['B', num2str(i), '_pred_real_nc.pdf']), ...
    fullfile(outdir, ['B', num2str(i), '_pred_real.svg']), ...
    vertex, tri, E_pred_real, c_real, exp_real);

saveFieldPDFNoColorbar_SVGColorbar( ...
    fullfile(outdir, ['B', num2str(i), '_true_real_nc.pdf']), ...
    fullfile(outdir, ['B', num2str(i), '_true_real.svg']), ...
    vertex, tri, E_true_real, c_real, exp_real);

saveFieldPDFNoColorbar_SVGColorbar( ...
    fullfile(outdir, ['B', num2str(i), '_res_real_nc.pdf']), ...
    fullfile(outdir, ['B', num2str(i), '_res_real.svg']), ...
    vertex, tri, E_res_real, c_res_real, exp_res_real);

saveFieldPDFNoColorbar_SVGColorbar( ...
    fullfile(outdir, ['B', num2str(i), '_pred_imag_nc.pdf']), ...
    fullfile(outdir, ['B', num2str(i), '_pred_imag.svg']), ...
    vertex, tri, E_pred_imag, c_imag, exp_imag);

saveFieldPDFNoColorbar_SVGColorbar( ...
    fullfile(outdir, ['B', num2str(i), '_true_imag_nc.pdf']), ...
    fullfile(outdir, ['B', num2str(i), '_true_imag.svg']), ...
    vertex, tri, E_true_imag, c_imag, exp_imag);

saveFieldPDFNoColorbar_SVGColorbar( ...
    fullfile(outdir, ['B', num2str(i), '_res_imag_nc.pdf']), ...
    fullfile(outdir, ['B', num2str(i), '_res_imag.svg']), ...
    vertex, tri, E_res_imag, c_res_imag, exp_res_imag);

% =====================================================
%  3) Save epsilon and Ebz real-part PDF/SVG
% =====================================================
eps_file = fullfile(outdir, ['B', num2str(i), '_epsilon_real.pdf']);
ebz_file = fullfile(outdir, ['B', num2str(i), '_Ebz_real.pdf']);

saveEpsilonPDF(eps_file, X, Y, eps_real);
saveEbzNoColorbarPDFOnly(ebz_file, X, Y, Ebz_real);

ebz_file = fullfile(outdir, ['B', num2str(i), '_Ebz_imag.pdf']);
...
set(fig_pdf, 'PaperPosition',[0 0 1.2 1.2]);
set(fig_pdf, 'PaperSize',[1.2 1.2]);
