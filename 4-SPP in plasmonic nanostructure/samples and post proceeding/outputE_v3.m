...
load(fullfile(mat_dir, 'Train_data_SPP14_41.mat'))
load(fullfile(mat_dir, 'deepOnet_data_SPP14_41.mat'))
load(fullfile(mat_dir, 'E_test_pred_size_41.mat'))
load(fullfile(mat_dir, 'idx_SPP14_41.mat'))
...
Et = E_pred(i, 1:coord_len_test(i)).';
[Ex, Ey] = GetExEy(Mesh.vertex, Mesh.tri, Mesh.edgesOfTri, Et);

Et_true = Ez_test(i, 1:coord_len_test(i)).';
...
%% =====================================================
saveSinglePDF(fullfile(outdir, ['SPP14', num2str(i), '_E_norm_pred.pdf']), ...
    vertex, tri, normE, c_norm, exp_norm);

saveSinglePDF(fullfile(outdir, ['SPP14', num2str(i), '_E_norm_true.pdf']), ...
    vertex, tri, normE_true, c_norm, exp_norm);

saveSinglePDF(fullfile(outdir, ['SPP14', num2str(i), '_E_norm_res.pdf']), ...
    vertex, tri, normE_res, c_res, exp_res);

%% =====================================================
%  3) Save epsilon and Ebz real-part PDF
%% =====================================================
eps_file = fullfile(outdir, ['SPP14', num2str(i), '_epsilon_real.pdf']);
