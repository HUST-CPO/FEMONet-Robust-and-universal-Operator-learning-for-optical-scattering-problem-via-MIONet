...
load(fullfile(mat_dir, 'deepOnet_data_C_3456.mat'))
load(fullfile(mat_dir, 'idx_C_3456.mat'))
load(fullfile(mat_dir, 'E_test_pred_size_3456.mat'))
...
Ebz_real = squeeze(Ebz_all(sample_id, :, :, 1));
Ebz_imag = squeeze(Ebz_all(sample_id, :, :, 2));
...
%
%  PDF: no colorbar, filename *_nc.pdf
%  SVG: with colorbar, filename *.svg
%% =====================================================

saveFieldPDFNoColorbar_SVGColorbar( ...
    fullfile(outdir, ['C', num2str(i), '_pred_real_nc.pdf']), ...
    fullfile(outdir, ['C', num2str(i), '_pred_real.svg']), ...
    vertex, tri, E_pred_real, c_real, exp_real);

saveFieldPDFNoColorbar_SVGColorbar( ...
    fullfile(outdir, ['C', num2str(i), '_true_real_nc.pdf']), ...
    fullfile(outdir, ['C', num2str(i), '_true_real.svg']), ...
    vertex, tri, E_true_real, c_real, exp_real);

saveFieldPDFNoColorbar_SVGColorbar( ...
    fullfile(outdir, ['C', num2str(i), '_res_real_nc.pdf']), ...
    fullfile(outdir, ['C', num2str(i), '_res_real.svg']), ...
    vertex, tri, E_res_real, c_res_real, exp_res_real);

saveFieldPDFNoColorbar_SVGColorbar( ...
    fullfile(outdir, ['C', num2str(i), '_pred_imag_nc.pdf']), ...
    fullfile(outdir, ['C', num2str(i), '_pred_imag.svg']), ...
    vertex, tri, E_pred_imag, c_imag, exp_imag);

saveFieldPDFNoColorbar_SVGColorbar( ...
    fullfile(outdir, ['C', num2str(i), '_true_imag_nc.pdf']), ...
    fullfile(outdir, ['C', num2str(i), '_true_imag.svg']), ...
    vertex, tri, E_true_imag, c_imag, exp_imag);

saveFieldPDFNoColorbar_SVGColorbar( ...
    fullfile(outdir, ['C', num2str(i), '_res_imag_nc.pdf']), ...
    fullfile(outdir, ['C', num2str(i), '_res_imag.svg']), ...
    vertex, tri, E_res_imag, c_res_imag, exp_res_imag);

%% =====================================================
%  3) Save epsilon and Ebz real-part PDF/SVG
%% =====================================================
eps_file = fullfile(outdir, ['C', num2str(i), '_epsilon_real.pdf']);
ebz_file = fullfile(outdir, ['C', num2str(i), '_Ebz_real.pdf']);

saveEpsilonPDF(eps_file, X, Y, eps_real);
saveEbzNoColorbarPDFOnly(ebz_file, X, Y, Ebz_real);

ebz_file = fullfile(outdir, ['C', num2str(i), '_Ebz_imag.pdf']);
saveEbzNoColorbarPDFOnly(ebz_file, X, Y, Ebz_imag);
...
disp(['Ebz (real part) PDF/SVG saved: ', ebz_file]);
...
% =====================================================
% PDF: field only, no colorbar, *_nc.pdf
% SVG: with colorbar, *.svg
% =====================================================
...
% =====================================================
% Ebz export: field only, no colorbar
% =====================================================
...
% No colorbar; field fills figure
axPos = [0 0 1 1];
...
% =====================================================
% PDF version: field only, no colorbar
% =====================================================
