...
load(fullfile(mat_dir, 'Train_data_A_unseen.mat'))
...
% testIdx = sort(idx(1:testSize));  % first a% for test
% trainIdx = sort(idx(testSize+1:end));  % rest for train

%load(fullfile(mat_dir, 'idx_A_1558.mat'))
load(fullfile(mat_dir, 'idx_A_unseen.mat'))
...
save(fullfile(mat_dir, 'deepOnet_data_A_unseen.mat'), ...
     'X_train','X_test', ...
...
save(fullfile(mat_dir, 'idx_A_unseen.mat'),'trainIdx','testIdx');